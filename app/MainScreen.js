    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.headerSection}>
          <Text style={styles.welcome}>欢迎，Tan！</Text>
          <Text style={styles.subtitle}>今天想做什么？</Text>
        </View>
        ...
        <View style={styles.buttonGrid}>
          ...
          >
            ...
            <Text style={styles.buttonSubtext}>即将到来</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.buttonText}>积分与奖励</Text>
            <Text style={styles.buttonSubtext}>兑换您的奖励</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.buttonText}>帮助与支持</Text>
            <Text style={styles.buttonSubtext}>请求我们的帮助与支持</Text>
          </TouchableOpacity>
        </View>
